...
- (UILabel *)stateLabel {
    if (!_stateLabel) {
        CGFloat top = KIsiPhoneX?35:20;
        _stateLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, top, 80, 40)];
        _stateLabel.text = @"未连接";
...
- (UIButton *)cameraButton {
    if (!_cameraButton) {
        ...
        _cameraButton.size = CGSizeMake(44, 44);
         CGFloat top = KIsiPhoneX?35:20;
        _cameraButton.origin = CGPointMake(_closeButton.left - 10 - _cameraButton.width, top);
...
- (UIButton *)beautyButton {
    if (!_beautyButton) {
        ...
        CGFloat top = KIsiPhoneX?35:20;
        _beautyButton.origin = CGPointMake(_cameraButton.left - 10 - _beautyButton.width, top);
